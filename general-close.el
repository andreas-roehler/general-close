...
;; URL: https://github.com/andreas-roehler/general-close.git
...
(defvar  general-close-install-directory default-directory
...
(and general-close-debug-p (message "general-close.el: default-directory: %s" default-directory))
...
(defvar general-close-unary-delimiter-chars (list ?` ?\" ?' ?+ ?: ?$ ?#)
  "Permitted unary delimiters." )
(make-variable-buffer-local 'general-close-unary-delimiter-chars)
...
(defcustom general-close-known-string-inpolation-opener  (list ?{ ?\( ?\[)
  "Syntactic-close-known-string-inpolation-opener."
  :type '(repeat character)
  :group 'sytactic-close)

(defcustom general-close-paired-openers (list ?< ?\( ?\[ ?{ ?\〈 ?\⦑ ?\⦓ ?\【 ?\⦗ ?\⸤ ?\「 ?\《 ?\⦕ ?\⸨ ?\⧚ ?\｛ ?\（ ?\［ ?\｟ ?\｢ ?\❰ ?\❮ ?\“ ?\‘ ?\❲ ?\⟨ ?\⟪ ?\⟮ ?\⟦ ?\⟬ ?\❴ ?\❪ ?\❨ ?\❬ ?\᚛ ?\〈 ?\⧼ ?\⟅ ?\⸦ ?\﹛ ?\﹙ ?\﹝ ?\⁅ ?\⦏ ?\⦍ ?\⦋ ?\₍ ?\⁽ ?\༼ ?\༺ ?\⸢ ?\〔 ?\『 ?\⦃ ?\〖 ?\⦅ ?\〚 ?\〘 ?\⧘ ?\⦉ ?\⦇)
  "Specify the delimiter char."
  :type '(repeat character)
  :group 'sytactic-close)

;; (setq general-close-paired-openers

;;    (list ?‘ ?< ?\( ?\[ ?{ ?\〈 ?\⦑ ?\⦓ ?\【 ?\⦗ ?\⸤ ?\「 ?\《 ?\⦕ ?\⸨ ?\⧚ ?\｛ ?\（ ?\［ ?\｟ ?\｢ ?\❰ ?\❮ ?\“ ?\‘ ?\❲ ?\⟨ ?\⟪ ?\⟮ ?\⟦ ?\⟬ ?\❴ ?\❪ ?\❨ ?\❬ ?\᚛ ?\〈 ?\⧼ ?\⟅ ?\⸦ ?\﹛ ?\﹙ ?\﹝ ?\⁅ ?\⦏ ?\⦍ ?\⦋ ?\₍ ?\⁽ ?\༼ ?\༺ ?\⸢ ?\〔 ?\『 ?\⦃ ?\〖 ?\⦅ ?\〚 ?\〘 ?\⧘ ?\⦉ ?\⦇))

(defcustom general-close-paired-closers (list ?’ ?> ?\) ?\] ?} ?\〉 ?\⦒ ?\⦔ ?\】 ?\⦘ ?\⸥ ?\」 ?\》 ?\⦖ ?\⸩ ?\⧛ ?\｝ ?\） ?\］ ?\｠ ?\｣ ?\❱ ?\❯ ?\” ?\’ ?\❳ ?\⟩ ?\⟫ ?\⟯ ?\⟧ ?\⟭ ?\❵ ?\❫ ?\❩ ?\❭ ?\᚜ ?\〉 ?\⧽ ?\⟆ ?\⸧ ?\﹜ ?\﹚ ?\﹞ ?\⁆ ?\⦎ ?\⦐ ?\⦌ ?\₎ ?\⁾ ?\༽ ?\༻ ?\⸣ ?\〕 ?\』 ?\⦄ ?\〗 ?\⦆ ?\〛 ?\〙 ?\⧙ ?\⦊ ?\⦈)
  "Specify the delimiter char."
  :type '(repeat character)
  :group 'sytactic-close)

;; (setq general-close-paired-closers
;;       (list ?’ ?> ?\) ?\] ?} ?\〉 ?\⦒ ?\⦔ ?\】 ?\⦘ ?\⸥ ?\」 ?\》 ?\⦖ ?\⸩ ?\⧛ ?\｝ ?\） ?\］ ?\｠ ?\｣ ?\❱ ?\❯ ?\” ?\’ ?\❳ ?\⟩ ?\⟫ ?\⟯ ?\⟧ ?\⟭ ?\❵ ?\❫ ?\❩ ?\❭ ?\᚜ ?\〉 ?\⧽ ?\⟆ ?\⸧ ?\﹜ ?\﹚ ?\﹞ ?\⁆ ?\⦎ ?\⦐ ?\⦌ ?\₎ ?\⁾ ?\༽ ?\༻ ?\⸣ ?\〕 ?\』 ?\⦄ ?\〗 ?\⦆ ?\〛 ?\〙 ?\⧙ ?\⦊ ?\⦈))

(defcustom general-close--escape-char 92
  "Customize the escape char if needed."
  :type 'char
  :group 'sytactic-close)

(defun general-close--escaped-p (&optional pos)
  "Return t if char at POS is preceded by an odd number of backslashes. "
  (save-excursion
    (when pos (goto-char pos))
    (< 0 (% (abs (skip-chars-backward "\\\\")) 2))))

(defun general-close--escaped-in-string-p ()
  "Return t if char at POS is escaped. "
  (let ((orig (point)))
  (save-excursion
    (and (eq 0 (% (abs (skip-chars-backward "\\\\")) 2))(< (point) orig)))))

(defun general-close--escapes-maybe (limit)
...
(defun general-close--padding-maybe (&optional pos)
...
(defun general-close--multichar-intern (char limit)
    (abs (skip-chars-backward (char-to-string char) limit)))

(defun general-close--multichar-closer (char limit &optional offset)
...
Optional argument OFFSET already know offset."
  (if offset
      (make-string (+ offset (general-close--multichar-intern char limit)) (general-close--return-complement-char-maybe char))
    (make-string (general-close--multichar-intern char limit) (general-close--return-complement-char-maybe char))))

(defun general-close-pure-syntax  (pps)
...
Argument PPS is result of ‘parse-partial-sexp’"
  (save-excursion
	...
	(setq closer (char-to-string (general-close--return-complement-char-maybe (char-after))))
	(when general-close-honor-padding-p (setq padding (general-close--padding-maybe (1+ (point))))))
       ((nth 3 pps)
	(goto-char (nth 8 pps))
...
(unless (functionp 'empty-line-p)
 ...
 (defvar general-close-tag nil
  "Functions closing mode-specific might go here.")

(defcustom general-close-electric-delete-whitespace-p nil
...
(defcustom general-close-honor-padding-p t
  "Insert whitespace following opener before closer.

Default is t"
  :type 'boolean
  :tag "general-close-honor-padding-p"
  :group 'general-close)
(make-variable-buffer-local 'general-close-honor-padding-p)

(defvar general-close--semicolon-separator-modes
  (list
   'inferior-sml-mode
   'js-mode
   'js2-mode
  ...
  "general-close--semicolon-separator-modes")

(defvar general-close--ml-modes
  (list
   'html-mode
   'mhtml-mode
   'sgml-mode
  ...
  "general-close--ml-modes")

(defvar general-close-modes (list
			       'agda2-mode
			       'emacs-lisp-mode
			       'html-mode
                               'haskell-mode
...
(defvar general-close-indent-modes (list
				      'ruby-mode)
...
(defvar general-close-import-re "^[ \t]*import[ \t]+.+"
  "")

(defvar general-close-for-re "^[ \t]*for([^)]+"
  "")

(defvar general-close-verbose-p nil)

(defvar general-close-assignment-re   "^[^:]*[^ =\t:]+[ \t]+=[ \t]+[^=]+" "")

(setq general-close-assignment-re     "^[^:]*[^ =\t:]+[ \t]+=[ \t]+[^=]+")

(defvar general-close-funcdef-re   "^[ \t]*def[ \t]+[[:alnum:]_]+([^()]+)" "")
...
(defvar  general-close-beg-delimiter "»‘“{<[("
  "Specify the delimiter char.")

(defvar  general-close-end-delimiter "«’”}>])"
  "Specify the delimiter char.")
...
(defvar general-close-match-in-comment-p nil
  "Internal use only.")
...
(defun general-close--string-delim-intern (pps)
...
Optional argument PPS should deliver the result of ‘parse-partial-sexp’."
  ...
  (save-excursion
    (let* ((pps (or pps (parse-partial-sexp (point-min) (point))))
	   (erg (when (nth 3 pps)
		  (general-close--string-delim-intern pps))))
      (unless erg
	(when (looking-at "\"")
	  (forward-char 1)
	  (setq pps (parse-partial-sexp (line-beginning-position) (point)))
	  (when (nth 3 pps)
	    (setq erg (general-close--string-delim-intern pps)))))
      (when (and general-close-verbose-p (called-interactively-p 'any)) (message "%s" erg))
      erg)))

(defun general-close-fix-whitespace-maybe (orig)
...
(defun general-close--string-fence-intern (orig start end)
  "Close comments.

ORIG the position where ‘general-close’ was called
START the comment start
END the comment end"
  (if (looking-at start)
      (progn (goto-char orig)
	     (fixup-whitespace)
	     (general-close-insert-with-padding-maybe end nil t))
    (goto-char orig)
    (newline-and-indent)))
...
Argument PPS should provide result of ‘parse-partial-sexp’."
  ...
  (when (looking-at comment-start-skip)
    (if (< 1 (length (match-string-no-properties 0)))
        (general-close--string-fence orig)
...
(defun general-close-ml ()
  ...
  (cond ((derived-mode-p 'sgml-mode)
	 (setq general-close-tag 'sgml-close-tag)
	 (funcall general-close-tag)
...
;; (defun general-close-haskell (orig pps)
...
;;     ;;                  (general-close--return-complement-string-maybe "{-")
;;     ;;)
;;     (let ((splitter (and
...
;;          ;; ((nth 1 pps)
;; 	 ;;             (general-close--haskell-list-forms orig pps))
;;          ((nth 3 pps)
    ...
    (unless (bobp)
      ...
      (unless (looking-at (concat "[" begdel "]+"))
        (while (and (< 0 (abs (skip-chars-backward (concat "^" begdel) limit)))
                    (or (and (not general-close-match-in-comment-p)
    ...
    (cond ((eq major-mode 'emacs-lisp-mode)
           (cond ((and (string= "|" (match-string-no-properties 0))
                 ...
                 ((and (< 1 (length (match-string-no-properties 0)))
                     (not (general-close--string-fence (point)))
                     t))
                 (t nil)))
          (t nil))))

(defun general-close--generic-splitted (escaped padding)
  (progn
    (if (< 1 (length (match-string-no-properties 0)))
        (if escaped
            (concat "\\\\" (general-close--string-fence (match-string-no-properties 0)))
          (general-close--string-fence (match-string-no-properties 0)))
      (if padding
          (if escaped
              (concat "\\\\" (concat padding (char-to-string (general-close--return-complement-char-maybe (char-after)))))
            (concat padding (char-to-string (general-close--return-complement-char-maybe (char-after)))))
        (if escaped
            (concat "\\\\"
  ...
  (save-restriction
    ...
    (let ((escaped (if (nth 3 pps)
      ...
      (cond
       ...
       ((and (nth 3 pps) (ignore-errors (equal (char-after) (nth 3 pps))) (nth 3 (parse-partial-sexp (point-min) (point))))
        (char-to-string (nth 3 pps)))
       ...
       ;;))
       (t (general-close-intern--repeat orig pps limit))))))
...
;;     ;; (delimiters (concat general-close-paired-openers-strg general-close-paired-closers-strg unary-delimiters-strg))
;;     (cond
...
(defun general-close--paren-inside-string (pos)
  ...
  (let (
    ...
    (while (and (or
                 (prog1
                     (and
                      (general-close--paren-conditions bracecounter bracecounter parencounter)
                      (forward-char -1)))
...
(defun general-close--check-bracecounter (bracecounter doublequotecounter singlequotecounter)
...
(defun general-close--check-bracketcounter (bracketcounter doublequotecounter singlequotecounter)
...
(defun general-close--check-parencounter (parencounter doublequotecounter singlequotecounter)
...
(defun general-close--check-doublequotecounter (doublequotecounter bracecounter)
  (cond ((and (< 0 (% doublequotecounter 2)) (eq (char-after) ?\"))
         (if (<  bracecounter 0)
             "}"
           (char-to-string (general-close--return-complement-char-maybe (char-after)))))))

(defun general-close--check-singlequotecounter (singlequotecounter bracecounter)
  (cond ((and (< 0 (% singlequotecounter 2)) (eq (char-after) ?'))
         (if (<  bracecounter 0)
             "}"
           (char-to-string (general-close--return-complement-char-maybe (char-after)))))))

(defun general-close--discard-closed-braced ()
  (interactive)
  (save-excursion
    (let ((bracecounter 0))
      (while
        ...
        (unless (general-close--escaped-p)
          (cond
           ((eq (char-after) ?{)
            (setq bracecounter (1+ bracecounter)))
           ((eq (char-after) ?})
...
(defun general-close--python-f-string (strg &optional bracecounter bracketcounter parencounter doublequotecounter singlequotecounter erg)
  (with-temp-buffer
    ...
    (let ((bracecounter (or bracecounter 0))
          ...
          (erg (or erg nil))
          padding)
      (general-close--discard-closed-braced)
      (while (general-close--escaped-p)
        (forward-char -1))
      (when
          (or
        ...
        (when (or (and (member (char-after) (list 40 91 ?{))
                       (not (general-close--escaped-p)))
                  (bobp))
          (when (looking-at ".\\([ \t]+\\)")
            (setq padding (match-string-no-properties 1)))
          (setq erg (or (general-close--check-bracecounter bracecounter doublequotecounter singlequotecounter)
                        (general-close--check-bracketcounter bracketcounter doublequotecounter singlequotecounter)
                        (general-close--check-parencounter parencounter doublequotecounter singlequotecounter)
                        (general-close--check-doublequotecounter doublequotecounter bracecounter)
                        (general-close--check-singlequotecounter singlequotecounter bracecounter)
                        (cond
        ...
        (if erg
            (if padding
              ...
              erg)
          (general-close--python-f-string (buffer-substring-no-properties (line-beginning-position) (point)) bracecounter bracketcounter parencounter doublequotecounter singlequotecounter erg))))))

(defun general-close-python-close (orig limit pps)
...
Optional argument PPS is result of a call to function ‘parse-partial-sexp’"
  (let* ((f-pos (progn (while (re-search-backward "\\(.*\\)[fF]r?\\(['\"]\\{1,3\\}\\).*" (line-beginning-position) t)) (match-beginning 2))))
    (cond
     (f-pos
      (general-close--python-f-string (buffer-substring-no-properties f-pos orig)))
     ((and (nth 8 pps) (nth 3 pps))
      (or (save-excursion (general-close--paren-inside-string (nth 8 pps)))
	  (save-excursion (goto-char (nth 8 pps)) (looking-at "[\"']\\{1,3\\}") (match-string-no-properties 0))))
     ((nth 1 pps)
      (general-close-pure-syntax pps))
...
;; Haskell
(defun general-close-haskell (orig pps limit)
  "Optional argument PPS is result of a call to function ‘parse-partial-sexp’"
  (interactive "*")
  (let* ((pps (or pps (parse-partial-sexp (point-min) (point)))))
    (cond
...
(defun general-close-ruby-close (orig pps)
  "Ruby specific close.

Argument PPS is result of a call to function ‘parse-partial-sexp’"
  (cond ((looking-back "#{[_[:alpha:]][_[:alnum:]]*" (line-beginning-position))
         "}")
        ((ignore-errors (and (< (nth 1 pps) (nth 8 pps))(general-close--string-before-list-maybe  pps))))
	((and (or (nth 1 pps) (nth 3 pps)) (general-close-pure-syntax pps)))
	(t (general-close--ruby))))

(defun general-close-java-another-filter-clause (pps)
  ""
  (let ((pps pps))
    (cond ((save-excursion
             ;; (goto-char (nth 1 pps))
...
(defun general-close-java (orig pps limit)
  "Optional argument PPS is result of a call to function ‘parse-partial-sexp’"
  (interactive "*")
  (cond
   ((nth 8 pps)
    (general-close-generic-forms orig limit pps))
   ((nth 1 pps)
    (cond ((and (looking-back general-close-for-re (line-beginning-position)) (not (eq (char-before) ?\;)) (not (string-match "\\+\\+" (buffer-substring-no-properties (line-beginning-position) (point)))))
           "; ")
   ...
   ((and (looking-back general-close-funcdef-re (line-beginning-position))
         (eq (char-before) 41))
    ":")
   ...
   (t
    ";"
    ;; (general-close--generic nil nil pps)
    )))

(defun general-close-scala-another-filter-clause (pps)
...
(defun general-close-scala-close (orig limit pps)
  "Optional argument PPS is result of a call to function ‘parse-partial-sexp’"
  (interactive "*")
  (let* ((pps (or pps (parse-partial-sexp (point-min) (point)))))
    (cond
     ...
     ((nth 1 pps)
      (if (save-excursion (general-close-scala-another-filter-clause pps))
  ...
  (let ((closer
	...
	";"))
     ((ignore-errors (and (< (nth 1 pps) (nth 8 pps))
			  (setq closer (general-close--string-before-list-maybe pps)))))
     ((nth 3 pps)
      closer)
     ((and closer (string-match ")" closer))
      closer)
     ((save-excursion (beginning-of-line) (looking-at general-close-assignment-re))
      (setq closer ";"))
     (t closer))))

(defun general-close--specific-modes (orig pps limit)
  "Argument PPS result of ‘parse-partial-sexp’."
  (pcase major-mode
    (`agda2-mode
    ...
    (`haskell-mode
     (general-close-haskell orig pps limit))
    (`java-mode
     (general-close-java orig pps limit))
    (`mhtml-mode
     (general-close-ml))
    (`nxml-mode
    ...
    (`scala-mode
     (general-close-scala-close orig limit pps))
    (`shell-mode
     (general-close-shell-close orig pps limit))
    (`sgml-mode
     (general-close-ml))
    (`xml-mode
     (general-close-ml))
...
(defun general-close--modes (orig pps limit)
  "Argument PPS, the result of ‘parse-partial-sexp’."
  (cond ((member major-mode general-close--semicolon-separator-modes)
         (general-close--semicolon-modes orig pps limit))
        ;; (pcase major-mode
        ;;   (`java-mode (general-close--semicolon-modes pps))
        ;;   (`js-mode (general-close--semicolon-modes pps))
        ;;   (`php-mode (general-close--semicolon-modes pps))
        ;;   (`python-mode (general-close-python-close pps))
        ;;   (`web-mode (general-close--semicolon-modes pps))
        ;;   (_
        (t
         ;; (if
	 ;;       (ignore-errors (and (nth 3 pps) (< (nth 1 pps) (nth 8 pps))))
	 ;;       (general-close--string-before-list-maybe pps)
	 (general-close--specific-modes orig pps limit))))

(defun general-close--finish-element ()
...
Optional argument PPS, the result of ‘parse-partial-sexp’."
  (when general-close-electric-delete-whitespace-p
  ...
  (let ((closer
    ...
    (when (and closer (stringp closer))
      ...
      (insert closer)
      ;; ruby end
      (when (member major-mode general-close-indent-modes)
...
Argument PPS, the result of ‘parse-partial-sexp’."
  ...
  (let* ((orig (copy-marker (point)))
	 (beg (or beg (general-close--point-min)))
	 (pps (or pps (parse-partial-sexp beg (point))))
         (limit (cond
                 ...
                 ((nth 1 pps))
                 (t (point-min))))
         (general-close-match-in-string-p (when (nth 3 pps) (nth 8 pps)))
         (general-close-match-in-comment-p (nth 4 pps))
	 (iact (or iact arg))
	 (arg (or arg 1))
         (general-close-delimiters-atpt (general-close-update-delimiters)))
    (pcase (prefix-numeric-value arg)
      (4 (while (general-close-intern (setq orig (copy-marker (point))) iact pps limit))
	 (< orig (point)))
      (_ (general-close-intern orig iact pps limit)
         (< orig (point))))))
